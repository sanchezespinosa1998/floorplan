            ...
            {activeTab === "roles" && isAdmin && (
              <div className="bg-card rounded-lg border border-border">
                <div className="px-6 py-4 border-b border-border">
                  ...
                  <p className="text-sm text-muted-foreground">Configuración de roles y permisos del sistema</p>
                </div>
                    ...
                    <div key={role} className="px-6 py-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {usersList.filter(u => u.role === role).length} usuario(s)
                        </span>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        {role === "admin" && "Acceso completo a todas las funcionalidades del sistema. User management, configuración y todas las operaciones."}
                        {role === "architect" && "Creación y edición de proyectos, planos, versiones y gestión técnica de proyectos."}
                        {role === "commercial" && "Management de reservas, atención a clientes y seguimiento comercial."}
                        {role === "exhibitor" && "Limited access to the exhibitor portal con información de su stand asignado."}
                        {role === "viewer" && "Solo visualización de proyectos, ferias y planos sin capacidad de edición."}
                      </p>
                    </div>
                  ))}
                </div>
            ...
            {activeTab === "sistema" && isAdmin && (
              <div className="bg-card rounded-lg border border-border">
                <div className="px-6 py-4 border-b border-border">
                  ...
                  <p className="text-sm text-muted-foreground">Opciones globales de configuración</p>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between py-2 border-b border-border">
                        ...
                        <span className="font-medium">Europe/Madrid</span>
                      </div>
                    </div>
                  </div>
                  
                  <div className="space-y-3">
                    <h4 className="font-medium text-sm">Módulos actives</h4>
                    <div className="space-y-2">
                      {[
                        { name: "Management de proyectos", active: true },
                        { name: "Portal de expositor", active: true },
                        { name: "Reservations online", active: true },
                        { name: "Notificaciones", active: true },
                      ].map(item => (

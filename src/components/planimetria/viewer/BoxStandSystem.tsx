...
function SideDuplicateArrow({ position, side, onClick }: SideDuplicateArrowProps) {
  ...
  return (
    ...
    >
      <mesh position={[0, 0, 0.38]} renderOrder={1200}>
        <coneGeometry args={[0.34, 0.68, 16]} />
        <meshBasicMaterial
      ...
      <mesh position={[0, 0, -0.18]} renderOrder={1200}>
        <cylinderGeometry args={[0.12, 0.12, 0.56, 12]} />
        <meshBasicMaterial
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} renderOrder={1200}>
      ...
      <group ref={setGroupObj} position={stand.position} rotation={[0, stand.rotationY, 0]}>
        ...
        {isSelected && isScaleMode && (
          <>
            ...
            >
              <boxGeometry args={[0.28, Math.max(0.9, h * 0.45), Math.max(0.9, d * 0.45)]} />
              <meshBasicMaterial color="#fde68a" transparent opacity={0.55} depthTest={false} />
            </mesh>
            <mesh
              position={[-(w / 2 + 0.1), 0, 0]}
            ...
            >
              <boxGeometry args={[Math.max(0.9, w * 0.45), Math.max(0.9, h * 0.45), 0.28]} />
              <meshBasicMaterial color="#fde68a" transparent opacity={0.55} depthTest={false} />
            </mesh>
            <mesh
              position={[0, 0, d / 2 + 0.1]}
            ...
            >
              <boxGeometry args={[Math.max(0.9, w * 0.4), 0.24, Math.max(0.9, d * 0.4)]} />
              <meshBasicMaterial color="#fef3c7" transparent opacity={0.5} depthTest={false} />
            </mesh>
          </>
        )}
      </group>

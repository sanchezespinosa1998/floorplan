  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <ListFilters
        ...
        searchPlaceholder="Buscar por versión, resumen o autor"
        searchAriaLabel="Buscar en historial"
        dateFrom={dateFrom}
        dateTo={dateTo}
        ...
        {paginatedVersions.map((version, index) => (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                {index > 0 && (
                  <button className="p-2 hover:bg-muted rounded-md transition-colors" title="Ver diff">
